...
const message = {
    ...
    go: {
        ...
        'zh-cn': '飞往 x:[X] y:[Y] z:[Z] 以速度 [SPEED] 厘米/秒',
    ...
    curve: {
        ...
        'zh-cn': '曲线飞行从 x:[X1] y:[Y1] z:[Z1] 到 x:[X2] y:[Y2] z:[Z2] 以速度 [SPEED] 厘米/秒',
    ...
    eduGo: {
        ...
        'zh-cn': '检测到 [MID] 挑战卡, 从挑战卡飞行到 x:[X] y:[Y] z:[Z] 用 [SPEED]厘米/秒 速度',
    ...
    eduCurve: {
        ...
        'zh-cn': '检测到 [MID] 挑战卡, 以弧线飞行从 x:[X1] y:[Y1] z:[Z1] 到 x:[X2] y:[Y2] z:[Z2] 用 [SPEED]厘米/秒 速度',
    ...
    eduJump: {
        ...
        'zh-cn': '检测到 [MID1] [MID2] , 从第一个挑战卡用 [SPEED] 厘米/秒 速度及旋转 [YAW] 角度飞往 x:[X] y:[Y] z:[Z] 第二个挑战卡',
